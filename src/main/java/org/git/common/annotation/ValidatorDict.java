...
import org.git.common.annotation.impl.ValidatorDictImpl;
...
@Constraint(validatedBy = ValidatorDictImpl.class)
//是最关键的，它表示这个注解是一个验证注解，并且指定了一个实现验证逻辑的验证器
public @interface ValidatorDict {
	String message() default "数据不符合码值规范";
	String code();
